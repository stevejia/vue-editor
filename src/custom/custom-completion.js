...
let htmlBlockElment = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'span', 'p', 'code', 'pre', 'ul', 'ol', 'li', 'table', 'thead', 'th', 'tbody', 'tr', 'td', 'tfoot', 'div', 'section']
htmlBlockElment.forEach(elKey => {
    let completion = genHtmlCompletion(elKey);
    completions.push(completion);
})
function genHtmlCompletion(elKey) {
    return {
        label: elKey,
        kind: monaco.languages.CompletionItemKind.Snippet,
        insertText: [
